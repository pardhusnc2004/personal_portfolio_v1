...
export function Skills() {
    return (
        <div className="container mt-2 text-center d-grid align-items-center justify-content-center" style={{paddingTop: "35px",paddingBottom: "100px"}}>
